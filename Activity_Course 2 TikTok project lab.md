...
==> ENTER YOUR RESPONSE HERE Prepare by reading in the data, viewing the data dictionary, and exploring the dataset to identify key variables for the stakeholder.
...
data_vc = data[mask]
print('claim state mean view count is ',data_vc['video_view_count'].mean())
print('claim state median view count is ',data_vc['video_view_count'].median())
```

    claim state mean view count is  501029.4527477102
    claim state median view count is  501555.0
...
data_vc = data[mask]
print('opinion state mean view count is ',data_vc['video_view_count'].mean())
print('opinion state median view count is ',data_vc['video_view_count'].median())
```

    opinion state mean view count is  4956.43224989447
    opinion state median view count is  4953.0
...
### YOUR CODE HERE ###
data.groupby(['claim_status','author_ban_status']).size().reset_index(name='count')
```
...
```python
### YOUR CODE HERE ###
data.groupby('author_ban_status')['video_view_count','video_like_count','video_share_count'].agg(['median','mean'])
```
...
### YOUR CODE HERE ###
data.groupby('author_ban_status')['video_share_count'].agg(['median'])
```
